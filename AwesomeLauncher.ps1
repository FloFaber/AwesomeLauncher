...
# Predefine font, width and height
...
[void]$AwesomeLauncher.controls.AddRange(@(
  $ListView,
  $ChangeUserButton,
  $LaunchButton,
  $CurrentUserLabel,
...
if(Test-Path "$ENV:APPDATA\AwesomeLauncher.cmd"){
  Remove-Item $ENV:APPDATA\AwesomeLauncher.cmd
}
